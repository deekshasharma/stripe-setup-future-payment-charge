...
var getSetupIntent = function(publicKey) {
  return fetch("/create-setup-intent", {
    ...
    .then(function(setupIntent) {
      localStorage.setItem("customerId", setupIntent.customer)
...
const orderComplete = async (stripe, clientSecret) => {
  const invoice = await fetch('/create-invoice/'+localStorage.getItem('customerId'), {method: 'POST'})
